...
const Footer: React.FC = () => {
    ...
    return (
        <footer id="contact-footer" className="bg-black text-gray-300">
            {/* Main Footer Content */}
            <div className="mx-auto max-w-full px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
                <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 justify-items-center items-start">
                    ...
                    <div className="space-y-3 sm:space-y-4 flex flex-col items-center w-full">
                        ...
                        <div className="space-y-2 sm:space-y-3 text-left w-full px-4 sm:px-0">
                            <div className="flex items-start space-x-2 sm:space-x-3">
                                <MapPin className="mt-0.5 sm:mt-1 h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 text-blue-400" />
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                ...
                                <p className="text-xs sm:text-sm">{t('02-451-1111')}</p>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <Globe className="h-4 w-4 sm:h-5 sm:w-5 text-purple-400 flex-shrink-0" />
                                <a
                                    href="https://www.kanokgroup.com"
                                    className="text-xs sm:text-sm transition-colors hover:text-white break-all"
                                >
                    ...
                    <div className="space-y-3 sm:space-y-4 flex flex-col items-center w-full">
                        ...
                        <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-left w-full px-4 sm:px-0">
                            <li className="flex items-center space-x-2">
                                <Package className="h-3 w-3 sm:h-4 sm:w-4 text-orange-400 flex-shrink-0" />
                    ...
                    {/* Company Highlights */}
                    <div className="space-y-3 sm:space-y-4 flex flex-col items-center w-full">
                        <h3 className="mb-3 sm:mb-4 text-lg sm:text-xl font-bold text-white">{t('จุดเด่นของเรา')}</h3>
                        <div className="space-y-2 sm:space-y-3 text-left w-full px-4 sm:px-0">
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <Award className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400 flex-shrink-0" />
                                <span className="text-xs sm:text-sm">{t('มาตรฐาน ISO 9001:2015')}</span>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <Award className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400 flex-shrink-0" />
                                <span className="text-xs sm:text-sm">{t('ได้รับมาตรฐาน TIS')}</span>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <Users className="h-4 w-4 sm:h-5 sm:w-5 text-cyan-400 flex-shrink-0" />
                                <span className="text-xs sm:text-sm">{t('ตัวแทนจำหน่าย 8,000+ แห่ง')}</span>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-400 flex-shrink-0" />
                                <span className="text-xs sm:text-sm">{t('ประสบการณ์ 25+ ปี')}</span>
                            </div>
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                <Package className="h-4 w-4 sm:h-5 sm:w-5 text-pink-400 flex-shrink-0" />
                                <span className="text-xs sm:text-sm">{t('ผลิตภัณฑ์ 9,000+ รายการ')}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 sm:mt-10 md:mt-12 border-t border-gray-700 pt-6 sm:pt-8">
                    <h3 className="mb-4 sm:mb-6 text-center text-lg sm:text-xl font-bold text-white">
            ...
            <div className="border-t border-gray-700 bg-gray-900">
                <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-5 md:py-6">
                    <div className="flex flex-col items-center justify-between space-y-3 sm:space-y-4 md:flex-row md:space-y-0">
                        ...
                        <div className="text-xs sm:text-sm text-gray-300 text-center md:text-right">{t('ผู้นำด้านระบบน้ำการเกษตร')}</div>
                    </div>
                </div>
            </div>
        </footer>
