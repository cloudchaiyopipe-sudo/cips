...
function FreeHome() {
    ...
    return (
        ...
        <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-200 selection:bg-green-500/30">
            ...
            {/* Custom Navbar */}
            <div className="sticky top-0 z-40 border-b border-white/5 bg-slate-900/50 backdrop-blur-md">
                <FreeNav />
            </div>
            ...
            <div className="flex min-h-[calc(100vh-80px)] flex-col items-center justify-between pb-16 md:pb-0">
                <motion.div
                    ...
                    initial="hidden"
                    animate="show"
                    className="w-full max-w-lg px-4 pb-12 pt-8 md:pb-16 md:pt-16"
                >
                    {/* Welcome Section */}
                    ...
                    <motion.div
                        ...
                        className="mb-8 overflow-hidden rounded-2xl border border-white/10 bg-slate-800/40 shadow-xl backdrop-blur-md"
                    >
                        ...
                        <div className="custom-scrollbar max-h-[300px] min-h-[200px] overflow-y-auto p-4">
                            {savedProjects.length > 0 ? (
                                                ...
                                                {editingProjectId === project.id ? (
                                                    ...
                                                    <div className="space-y-3">
                                                        <input
                                                            ...
                                                            className="w-full rounded-lg border border-slate-600 bg-slate-900/50 px-3 py-2 text-sm text-white placeholder-slate-500 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
                                                            autoFocus
                                                        ...
                                                        <div className="flex gap-2">
                                                            <button
                                                                ...
                                                                className="flex-1 rounded-md bg-green-600 py-1.5 text-xs font-medium text-white shadow transition-colors hover:bg-green-500"
                                                            >
                                                                บันทึก
                                                            </button>
                                                            <button
                                                                ...
                                                                className="flex-1 rounded-md bg-slate-600 py-1.5 text-xs font-medium text-white shadow transition-colors hover:bg-slate-500"
                                                            >
                                                                ยกเลิก
                                                            </button>
                                                        </div>
                                ...
                                <div className="flex h-full flex-col items-center justify-center py-10 opacity-50">
                                    ...
                                    <p className="text-sm text-slate-400">ไม่มีไฟล์ที่บันทึกไว้</p>
                                </div>
                            )}
                        </div>
                    </motion.div>
                ...
                {showAdModal && advertisements.length > 0 && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-md overflow-hidden rounded-2xl border border-white/10 bg-slate-800/80 shadow-2xl backdrop-blur-xl lg:max-w-lg"
                        >
                            {/* Header Gradient */}
                            ...
                            <button
                                ...
                                className="absolute right-3 top-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-black/20 text-white backdrop-blur-sm transition-all hover:rotate-90 hover:bg-red-500"
                            >
                                ✕
                            </button>
                            ...
                            <div className="p-6">
                                <div
                                    ...
                                    onClick={() =>
                                        handleAdClick(advertisements[currentAdIndex].link_url)
                                    }
                                >
                                ...
                                {advertisements.length > 1 && (
                                    <div className="mt-6 flex items-center justify-between">
                                        <button
                                            ...
                                            className="rounded-lg bg-white/5 px-4 py-2 text-sm text-white transition-colors hover:bg-white/10"
                                        >
                                            ← {translations.back}
                                        </button>
