...
export interface LanguageTranslations {
    ...
    // UpgradePro page
    cipsPro: string;
    forProfessionalUsers: string;
    proPlan: string;
    tokensPerMonth: string;
    tokensDaily: string;
    advancedIrrigationPlanning: string;
    ...
    kanokPhone: string;
    kanokWebsite: string;
    chaiyoPipeFitting: string;
    chaiyoAddress: string;
    chaiyoPhone: string;
    chaiyoEmail: string;
    loadingMap: string;
...
export const translations: Record<'EN' | 'TH', LanguageTranslations> = {
    EN: {
        ...
        pricing: '599 THB/month',
        cancelAnytime: 'Cancel anytime • No additional fees',
        noAdditionalFees: 'No additional fees',
        startImmediately: 'Start Immediately',
        availableImmediately: 'Available immediately after payment',
        easyPayment: 'Easy Payment',
        multiplePaymentMethods: 'Multiple payment methods supported',
        secure: 'Secure',
        ...
        // FreeFooter page
        kanokProducts: 'Kanok Products Co., Ltd.',
        kanokAddress:
            '15-23 Piraya Manthai Alley 10, Bang Khun Thian Road, Khlong Bang Bon Subdistrict, Bang Bon District, Bangkok 10150',
        kanokPhone: '02-451-1111',
        kanokWebsite: 'www.kanokgroup.com',
        chaiyoPipeFitting: 'Chaiyo Pipe & Fitting Co., Ltd.',
        chaiyoAddress:
        ...
        pumpWillDistributeWater:
            'The pump will distribute water from the water source to the zones',
        readyToDivideZones: '🗺️ Ready to Divide Zones',
        clickToDivideZonesButton:
            'Click the "Click to Divide Zones" button to automatically divide your area into irrigation zones',
        ...
        drawing: 'Click to draw area...',
        water: 'Water',
        waterCompleted: 'Water ✓',
        placingWater: 'Click to place water source...',
    ...
    TH: {
        ...
        pricing: '599 บาท/เดือน',
        cancelAnytime: 'ยกเลิกได้ตลอดเวลา • ไม่มีค่าธรรมเนียมเพิ่มเติม',
        noAdditionalFees: 'ไม่มีค่าธรรมเนียมเพิ่มเติม',
        startImmediately: 'เริ่มต้นทันที',
        availableImmediately: 'ใช้งานได้ทันทีหลังการชำระเงิน',
        easyPayment: 'การชำระเงินง่าย',
        multiplePaymentMethods: 'รองรับวิธีการชำระเงินหลากหลาย',
        secure: 'ปลอดภัย',
        ...
        currentTokens: 'โทเค็นปัจจุบัน:',
        monthlyTokens: 'โทเค็นรายเดือน:',
        ...
        watermelon: 'แตงโม',
        pumpkin: 'ฟักทอง',
        winterMelon: 'ฟักเขียว',

        // FreeFooter page
        kanokProducts: 'บริษัท กนก โปรดักส์ จำกัด',
        kanokAddress:
            '15-23 ซอยพิรยา มันทาย 10 ถนนบางขุนเทียน แขวงคลองบางบอน เขตบางบอน กรุงเทพมหานคร 10150',
        kanokPhone: '02-451-1111',
        kanokWebsite: 'www.kanokgroup.com',
        chaiyoPipeFitting: 'บริษัท ไชโย ไปป์ แอนด์ ฟิตติ้ง จำกัด',
        ...
        placingWaterPump: 'คลิก + เพื่อวางปั๊มน้ำ',
        ...
        clickToDivideZonesButton:
            'คลิกปุ่ม "คลิกเพื่อแบ่งโซน" เพื่อแบ่งพื้นที่ของคุณเป็นโซนชลประทานโดยอัตโนมัติ',
        ...
        drawing: 'คลิกเพื่อวาดพื้นที่...',
        water: 'แหล่งน้ำ',
        waterCompleted: 'แหล่งน้ำ ✓',
        placingWater: 'คลิกเพื่อวางแหล่งน้ำ...',
        placePump: 'วางปั๊ม',
        ...
        waterPressure: 'แรงดัน',
        sprinklerRadius: 'รัศมี',
        pipeSystemSummary: 'สรุประบบท่อ',
        mainPipe: 'ท่อเมน',
        subMainPipe: 'ท่อเมนย่อย',
        lateralPipe: 'ท่อย่อย',
        length: 'ยาว',
        outlets: 'ทางออก',
        flowRate: 'อัตราการไหล',
        mainPipeLabel: 'ท่อหลัก',
        subMainPipeLabel: 'ท่อเมนย่อย',
        lateralPipeLabel: 'ท่อย่อย',
        ...
        staticHead: 'Head Loss:',
        mainPipeLabel2: 'ท่อเมน',
        ...
        newProducts: 'ใหม่',
        promotionProducts: 'โปรโมชั่น',
        recommendedProducts: 'ทั้งหมด',
...
export const getTranslations = (): LanguageTranslations => {
