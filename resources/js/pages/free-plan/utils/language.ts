...
export const translations: Record<'EN' | 'TH', LanguageTranslations> = {
  EN: {
    ...
    uploadManageAds: "Upload and manage your advertisements that will be displayed on the free plan homepage.",
    ...
    kanokAddress: "15-23 Piraya Manthai Alley 10, Bang Khun Thian Road, Khlong Bang Bon Subdistrict, Bang Bon District, Bangkok 10150",
  ...
  TH: {
    ...
    kanokAddress: "15-23 ซอยพิรยา มันทาย 10 ถนนบางขุนเทียน แขวงคลองบางบอน เขตบางบอน กรุงเทพมหานคร 10150",
    kanokPhone: "02-451-1111",
    kanokWebsite: "www.kanokgroup.com",
