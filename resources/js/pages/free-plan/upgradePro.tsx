        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
            ...
            <div className="mx-auto max-w-4xl px-4 py-6 md:px-6 md:py-8">
                ...
                <div className="mb-8 flex items-center gap-4 text-white">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white md:text-4xl">{translations.cipsPro}</h1>
                        <p className="text-lg text-slate-300">{translations.forProfessionalUsers}</p>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-2xl">
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-700/40 to-slate-600/40 p-8 shadow-2xl backdrop-blur-sm border border-slate-600/30">
                        ...
                        <div className="mb-8 space-y-4">
                            ...
                            <div className="flex items-center gap-3 text-white">
                                ...
                                <span className="text-lg">{translations.advancedIrrigationPlanning}</span>
                            </div>
                        ...
                        <div className="text-center">
                            <button 
                                ...
                                className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 py-4 px-8 text-xl font-bold text-white shadow-lg transition-all duration-300 hover:from-blue-500 hover:to-blue-600 hover:shadow-xl hover:scale-105 active:scale-95"
                            >
                    ...
                    <div className="mt-8 grid gap-4 md:grid-cols-3">
                        <div className="rounded-lg bg-slate-700/30 p-4 text-center text-white">
                            ...
                            <div className="text-xs text-slate-300">{translations.availableImmediately}</div>
                        </div>
                        <div className="rounded-lg bg-slate-700/30 p-4 text-center text-white">
                            <div className="mb-2 text-2xl">💳</div>
                            <div className="font-semibold">{translations.easyPayment}</div>
                            <div className="text-xs text-slate-300">{translations.multiplePaymentMethods}</div>
                        </div>
                        <div className="rounded-lg bg-slate-700/30 p-4 text-center text-white">
                            <div className="mb-2 text-2xl">🔒</div>
