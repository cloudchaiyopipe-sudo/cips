...
export function getPE_PN63_Data(): PipeSizeData {
    return {
        ...
        '100mm': [
            // 4 นิ้ว
            // หมายเหตุ: ข้อมูลนี้เป็นข้อมูลอ้างอิงจากตาราง PVC Class 5/8.5 และควรตรวจสอบกับข้อมูลจริงจากผู้ผลิตท่อ PE PN 6.3
            { flow: 200, pressureLoss: 0.01 },
        ...
        '110mm': [
            // หมายเหตุ: ข้อมูลนี้เป็นข้อมูลประมาณการโดย extrapolate จากขนาด 90mm และ 100mm และควรตรวจสอบกับข้อมูลจริงจากผู้ผลิตท่อ PE PN 6.3
            { flow: 220, pressureLoss: 0.01 },
            { flow: 240, pressureLoss: 0.02 },
            { flow: 260, pressureLoss: 0.02 },
            { flow: 280, pressureLoss: 0.02 },
            { flow: 300, pressureLoss: 0.03 },
            { flow: 320, pressureLoss: 0.03 },
            { flow: 340, pressureLoss: 0.04 },
            { flow: 360, pressureLoss: 0.04 },
            { flow: 380, pressureLoss: 0.05 },
            { flow: 400, pressureLoss: 0.05 },
            { flow: 420, pressureLoss: 0.06 },
            { flow: 440, pressureLoss: 0.06 },
            { flow: 460, pressureLoss: 0.07 },
            { flow: 480, pressureLoss: 0.07 },
            { flow: 500, pressureLoss: 0.08 },
            { flow: 550, pressureLoss: 0.09 },
            { flow: 600, pressureLoss: 0.11 },
            { flow: 650, pressureLoss: 0.13 },
            { flow: 700, pressureLoss: 0.15 },
            { flow: 750, pressureLoss: 0.17 },
            { flow: 800, pressureLoss: 0.19 },
            { flow: 850, pressureLoss: 0.21 },
            { flow: 900, pressureLoss: 0.24 },
            { flow: 950, pressureLoss: 0.26 },
            { flow: 1000, pressureLoss: 0.29 },
            { flow: 1100, pressureLoss: 0.34 },
            { flow: 1200, pressureLoss: 0.4 },
            { flow: 1300, pressureLoss: 0.46 },
            { flow: 1400, pressureLoss: 0.53 },
            { flow: 1500, pressureLoss: 0.6 },
            { flow: 1600, pressureLoss: 0.68 },
            { flow: 1700, pressureLoss: 0.76 },
            { flow: 1800, pressureLoss: 0.85 },
            { flow: 1900, pressureLoss: 0.94 },
            { flow: 2000, pressureLoss: 1.04 },
            { flow: 2200, pressureLoss: 1.24 },
            { flow: 2400, pressureLoss: 1.46 },
            { flow: 2600, pressureLoss: 1.69 },
            { flow: 2800, pressureLoss: 1.94 },
            { flow: 3000, pressureLoss: 2.21 },
        ],
        '125mm': [
            // 5 นิ้ว
            // หมายเหตุ: ข้อมูลนี้เป็นข้อมูลอ้างอิงจากตาราง PVC Class 5/8.5 และควรตรวจสอบกับข้อมูลจริงจากผู้ผลิตท่อ PE PN 6.3
